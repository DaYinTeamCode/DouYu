...
public final class NetWorkConfiguration {
    ...
    public NetWorkConfiguration(Context content) {
        ...
        this.diskCache = new Cache(new File(content.getApplicationContext().getCacheDir(), "network"), maxDiskCacheSize);
        this.connectTimeout = 10;
        this.connectionPool = new ConnectionPool(10, 60 * 10, TimeUnit.SECONDS);
        certificates = null;
        baseUrl = null;
    }
